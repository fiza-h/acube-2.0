            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight">
                        How It <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-500">Works</span>
                    </h2>
                ...
                <div className="relative">
                    ...
                    <div className="hidden md:block absolute top-1/2 left-0 w-full h-0.5 bg-white/5 -translate-y-1/2">
                        <motion.div
                            ...
                            className="h-full bg-gradient-to-r from-zinc-500 via-white to-zinc-500"
                        />
                    </div>
                    ...
                    <div className="md:hidden absolute top-0 left-8 w-0.5 h-full bg-white/5">
                        <motion.div
                            ...
                            className="w-full bg-gradient-to-b from-zinc-500 via-white to-zinc-500"
                        />
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-12 md:gap-8">
                        {steps.map((step, index) => (
                            ...
                            >
                                ...
                                <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 top-0 md:top-1/2 md:-translate-y-1/2 md:-mt-24 w-16 h-16 rounded-full bg-zinc-900 border-2 border-white/10 flex items-center justify-center z-20 group-hover:border-white transition-colors duration-300 shadow-[0_0_20px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_30px_rgba(255,255,255,0.3)]">
                                    <step.icon className="w-8 h-8 text-white group-hover:text-zinc-300 transition-colors" />

                                    {/* Pulse Effect */}
                                    <div className="absolute inset-0 rounded-full border border-white/50 scale-100 animate-ping opacity-0 group-hover:opacity-20" />
                                </div>

                                {/* Card Content */}
                                <div className="bg-zinc-900/50 backdrop-blur-sm p-8 rounded-2xl border border-white/5 hover:bg-zinc-800/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl relative overflow-hidden">
                                    {/* Large Background Number */}
                                    <span className="absolute -right-4 -top-4 text-8xl font-bold text-white/5 select-none group-hover:text-white/10 transition-colors">
                                        {step.id}
                                    </span>
