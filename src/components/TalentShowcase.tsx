    ...
    <div className="w-full bg-zinc-900/80 backdrop-blur-md border border-white/5 rounded-2xl p-5 hover:border-white/20 transition-all duration-300 group cursor-pointer hover:bg-zinc-800/50 hover:-translate-y-1 hover:shadow-xl">
        <div className="flex items-start justify-between mb-4">
            <div className="flex items-center space-x-3">
                <div className="relative w-12 h-12 rounded-full overflow-hidden border border-white/10 group-hover:border-cyan-400/50 transition-colors">
                    <Image
                        src={talent.image}
                        alt={talent.name}
                        fill
                ...
                <div>
                    <h3 className="font-bold text-white text-sm flex items-center gap-1.5">
                        {talent.name}
                        {talent.verified && <CheckCircle className="w-3.5 h-3.5 text-cyan-400 fill-cyan-400/10" />}
                    </h3>
        ...
        <div className="flex items-center justify-between pt-3 border-t border-white/5">
            ...
            <button className="text-[10px] font-bold text-white flex items-center group-hover:text-cyan-400 transition-colors">
                ...
                <div className="absolute top-10 left-0 right-0 z-30 text-center px-6">
                    ...
                    >
                        <h2 className="text-4xl md:text-6xl font-bold text-white mb-4 tracking-tight drop-shadow-xl">
                            World-Class <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-white">Talent</span>
                        </h2>
