                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1 md:col-span-2">
                        <Link href="/" className="text-2xl font-bold tracking-tighter text-white mb-6 block group">
                            ACube<span className="text-blue-500 group-hover:text-blue-400 transition-colors">2.0</span>
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><Link href="#" className="text-zinc-400 hover:text-blue-400 transition-colors">Case Studies</Link></li>
                            <li><Link href="#" className="text-zinc-400 hover:text-blue-400 transition-colors">Careers</Link></li>
                            <li><Link href="#" className="text-zinc-400 hover:text-blue-400 transition-colors">Contact</Link></li>
                        </ul>
                    </div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <Link
                                    ...
                                    className="text-blue-400 hover:text-blue-300 transition-colors underline decoration-blue-500/50 underline-offset-4"
                                >
                                    Schedule a Call
                                </Link>
                            </li>
